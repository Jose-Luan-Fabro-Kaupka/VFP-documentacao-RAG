# Rotina de biblioteca API _WRightP( )

Retorna a posição na tela em pixels onde a borda direita da janela especificada está localizada.

```foxpro
unsigned int _WRightP(WHANDLE wh)
