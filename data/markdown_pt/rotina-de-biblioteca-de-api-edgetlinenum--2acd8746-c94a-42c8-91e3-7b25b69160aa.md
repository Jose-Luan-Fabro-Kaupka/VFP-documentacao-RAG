# Rotina de biblioteca de API _EdGetLineNum( )

Retorna o número da linha da posição de deslocamento thePos passada no arquivo na janela de edição especificada.
