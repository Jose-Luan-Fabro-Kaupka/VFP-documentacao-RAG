# Rotina de biblioteca de API _EdCopy( )

Copia a porção selecionada do arquivo na janela de edição especificada para a área de transferência.

```foxpro
void _EdCopy(WHANDLE wh)
